...
#        name):
#
#SBATCH --job-name=dynamicrafter-depth-04-20-2024
#
...
python train_depth.py backbone=dynamicrafter batch_size=8 backbone.batch_size=8 +backbone.return_multilayer=True
