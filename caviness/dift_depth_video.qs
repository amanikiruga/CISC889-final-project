...
#        name):
#
#SBATCH --job-name=dynamicrafter-depth-video-04-21
#
...
python train_depth_video.py batch_size=16 note="dift_video_probe_04_21" dataset.image_mean="imagenet" backbone=dift +backbone.return_multilayer=True
