...
python train_depth_video.py batch_size=16 note="dift_navi_reldepth_readout_regression_04_23" dataset=navi_reldepth optimizer.probe_lr=0.001 dataset.image_mean="imagenet" backbone=dift optimizer.n_epochs=200 +log_interval=50 +probe.scale_invariant=True