...
#        name):
#
#SBATCH --job-name=dynamicrafter_video_probe_readout_regression_step_1
#
...
python train_depth_video.py batch_size=16 note="dynamicrafter_video_probe_readout_regression_04_23" backbone.time_step=1  optimizer.probe_lr=0.001
